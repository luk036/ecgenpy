...
`ecgenpy` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/ecgenpy
[issue tracker]: https://github.com/<USERNAME>/ecgenpy/issues
